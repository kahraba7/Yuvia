...
const SERVICES_DEFAULT = [
  { id: 'skin-boosters',  cat: 'Injectables',    catAr: 'حقن',               name: 'Skin Boosters',            nameAr: 'منشطات البشرة',          img: 'service_skin_boosters.jpg', desc: 'Deep hydration injections that restore plumpness, elasticity, and a luminous glow — Standard and Advanced options available.', descAr: 'حقن ترطيب عميق تستعيد الامتلاء والمرونة والتألق — خيارات قياسية ومتقدمة.', duration: '30–45 min', durationMin: 45, price: 'Contact Clinic' },
  { id: 'aqua-facial',    cat: 'Facials',         catAr: 'فيشل',              name: 'Aqua Facial',              nameAr: 'أكوا فيشل',              img: 'service_facials.jpg',       desc: 'Deep cleansing and hydration treatment that unclogs pores, removes impurities, and leaves skin radiant and refreshed.', descAr: 'علاج تنظيف عميق وترطيب يفتح المسام ويزيل الشوائب ويترك البشرة متألقة.', duration: '60 min', durationMin: 60, price: 'Contact Clinic' },
  { id: 'oxygeneo',       cat: 'Facials',         catAr: 'فيشل',              name: 'OxyGeneo',                 nameAr: 'أوكسيجينيو',             img: 'service_oxygeneo.jpg',      desc: '3-in-1 super facial for exfoliation, oxygenation, and infusion. Your skin, fully alive.', descAr: 'فيشل ثلاثي في واحد للتقشير والأكسجين والتغذية. بشرتك، حية بالكامل.', duration: '60–75 min', durationMin: 75, price: 'Contact Clinic' },
  { id: 'hydra-plus',     cat: 'Facials',         catAr: 'فيشل',              name: 'Hydra-Plus Facial',        nameAr: 'فيشل هايدرا بلس',       img: 'service_facials.jpg',       desc: 'Intensive multi-step facial for ultimate glow — deep cleansing, hydration, and skin renewal.', descAr: 'فيشل متعدد المراحل للتألق الأقصى — تنظيف عميق وترطيب وتجديد البشرة.', duration: '75–90 min', durationMin: 90, price: 'Contact Clinic' },
  { id: 'rf-treatments',  cat: 'Body & Face',     catAr: 'الجسم والوجه',     name: 'RF Treatments',            nameAr: 'علاجات RF',              img: 'service_rf.jpg',            desc: 'RF Face or Neck (skin tightening & contouring), RF Hands (rejuvenation), or Advance RF with Mesotherapy.', descAr: 'RF الوجه أو الرقبة (شد وتنحيف)، RF اليدين (تجديد)، أو RF متقدم مع ميزوثيرابي.', duration: '45–60 min', durationMin: 60, price: 'Contact Clinic' },
  { id: 'eye-revive',     cat: 'Eye Care',        catAr: 'العناية بالعيون',  name: 'Eye Revive',               nameAr: 'إحياء العيون',           img: 'service_eye_revive.jpg',    desc: 'Basic: refreshing treatment for the delicate eye area. Advance: Basic + Dermapen application under the eye.', descAr: 'أساسي: علاج منعش لمنطقة العيون. متقدم: الأساسي مع ديرمابن تحت العين.', duration: '30–45 min', durationMin: 45, price: 'Contact Clinic' },
  { id: 'bio-pen',        cat: 'Skin Science',    catAr: 'علم البشرة',       name: 'Bio Pen',                  nameAr: 'بايو بن',                img: 'service_biopentxt.jpg',     desc: 'Standard treatment using the Bio Pen device for enhanced product absorption and skin rejuvenation.', descAr: 'علاج قياسي باستخدام جهاز Bio Pen لتعزيز امتصاص المنتجات وتجديد البشرة.', duration: '30–45 min', durationMin: 45, price: 'Contact Clinic' },
  ...
  { id: 'dermapen-pdrn',  cat: 'Skin Science',    catAr: 'علم البشرة',       name: 'Dermapen Salmon PDRN',     nameAr: 'ديرمابن سالمون PDRN',   img: 'service_biopentxt.jpg',     desc: 'Advanced microneedling with Salmon PDRN for skin regeneration, pore minimizing, and remarkably smooth skin.', descAr: 'حقن إبر متقدمة مع PDRN سالمون لتجديد البشرة وتصغير المسام.', duration: '45–60 min', durationMin: 60, price: 'Contact Clinic' },
  { id: 'bbb',            cat: 'Body Sculpting',  catAr: 'نحت الجسم',        name: 'Brazilian Butt Re-shaping', nameAr: 'إعادة تشكيل البرازيلي', img: 'service_bbb.jpg',           desc: 'Non-surgical body sculpting: fat stimulation & distribution, cellulite reduction, body contouring.', descAr: 'نحت الجسم غير الجراحي: تحفيز وتوزيع الدهون، تقليل السيلوليت، تنحيف الجسم.', duration: '45–60 min', durationMin: 60, price: 'Contact Clinic' },
];
