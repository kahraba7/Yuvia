...
const BA_IMAGES = [
  { img: 'ba_lip_booster.jpg',       doctorName: 'Yuvia Clinic', treatmentEn: 'Lip Booster',           treatmentAr: 'منشط الشفاه',       badge: 'Before & After' },
  { img: 'ba_skin_booster_face.jpg', doctorName: 'Yuvia Clinic', treatmentEn: 'Skin Booster',          treatmentAr: 'منشط البشرة',       badge: 'Before & After' },
  { img: 'ba_neck_booster.jpg',      doctorName: 'Yuvia Clinic', treatmentEn: 'Neck Skin Booster',     treatmentAr: 'منشط بشرة الرقبة', badge: 'Before & After' },
  { img: 'ba_dermapen.jpg',          doctorName: 'Yuvia Clinic', treatmentEn: 'Dermapen Salmon PDRN',  treatmentAr: 'ديرمابن سالمون',   badge: 'Before & After' },
  { img: 'ba_hydrafacial.jpg',       doctorName: 'Yuvia Clinic', treatmentEn: 'Hydra-Plus Facial',     treatmentAr: 'فيشل هايدرا بلس', badge: 'Before & After' },
  { img: 'ba_skin_booster_lips.jpg', doctorName: 'Yuvia Clinic', treatmentEn: 'Skin Booster',          treatmentAr: 'منشط البشرة',       badge: 'Before & After' },
];
...
const SERVICES_DEFAULT = [
  { id: 'skin-boosters',  cat: 'Injectables',    catAr: 'حقن',               name: 'Skin Boosters',            nameAr: 'منشطات البشرة',          desc: 'Deep hydration injections that restore plumpness, elasticity, and a luminous glow — Standard and Advanced options available.', descAr: 'حقن ترطيب عميق تستعيد الامتلاء والمرونة والتألق — خيارات قياسية ومتقدمة.', duration: '30–45 min', durationMin: 45, price: 'Contact Clinic' },
  { id: 'aqua-facial',    cat: 'Facials',         catAr: 'فيشل',              name: 'Aqua Facial',              nameAr: 'أكوا فيشل',              desc: 'Deep cleansing and hydration treatment that unclogs pores, removes impurities, and leaves skin radiant and refreshed.', descAr: 'علاج تنظيف عميق وترطيب يفتح المسام ويزيل الشوائب ويترك البشرة متألقة.', duration: '60 min', durationMin: 60, price: 'Contact Clinic' },
  { id: 'oxygeneo',       cat: 'Facials',         catAr: 'فيشل',              name: 'OxyGeneo',                 nameAr: 'أوكسيجينيو',             desc: '3-in-1 super facial for exfoliation, oxygenation, and infusion. Your skin, fully alive.', descAr: 'فيشل ثلاثي في واحد للتقشير والأكسجين والتغذية. بشرتك، حية بالكامل.', duration: '60–75 min', durationMin: 75, price: 'Contact Clinic' },
  { id: 'hydra-plus',     cat: 'Facials',         catAr: 'فيشل',              name: 'Hydra-Plus Facial',        nameAr: 'فيشل هايدرا بلس',       desc: 'Intensive multi-step facial for ultimate glow — deep cleansing, hydration, and skin renewal.', descAr: 'فيشل متعدد المراحل للتألق الأقصى — تنظيف عميق وترطيب وتجديد البشرة.', duration: '75–90 min', durationMin: 90, price: 'Contact Clinic' },
  { id: 'rf-treatments',  cat: 'Body & Face',     catAr: 'الجسم والوجه',     name: 'RF Treatments',            nameAr: 'علاجات RF',              desc: 'RF Face or Neck (skin tightening & contouring), RF Hands (rejuvenation), or Advance RF with Mesotherapy.', descAr: 'RF الوجه أو الرقبة (شد وتنحيف)، RF اليدين (تجديد)، أو RF متقدم مع ميزوثيرابي.', duration: '45–60 min', durationMin: 60, price: 'Contact Clinic' },
  { id: 'eye-revive',     cat: 'Eye Care',        catAr: 'العناية بالعيون',  name: 'Eye Revive',               nameAr: 'إحياء العيون',           desc: 'Basic: refreshing treatment for the delicate eye area. Advance: Basic + Dermapen application under the eye.', descAr: 'أساسي: علاج منعش لمنطقة العيون. متقدم: الأساسي مع ديرمابن تحت العين.', duration: '30–45 min', durationMin: 45, price: 'Contact Clinic' },
  { id: 'bio-pen',        cat: 'Skin Science',    catAr: 'علم البشرة',       name: 'Bio Pen',                  nameAr: 'بايو بن',                desc: 'Standard treatment using the Bio Pen device for enhanced product absorption and skin rejuvenation.', descAr: 'علاج قياسي باستخدام جهاز Bio Pen لتعزيز امتصاص المنتجات وتجديد البشرة.', duration: '30–45 min', durationMin: 45, price: 'Contact Clinic' },
  { id: 'peeling',        cat: 'Skin Science',    catAr: 'علم البشرة',       name: 'Peeling',                  nameAr: 'تقشير',                  desc: 'Professional chemical peeling: face or neck, hands, elbow or knees, bikini or underarms.', descAr: 'تقشير كيميائي احترافي: الوجه أو الرقبة، اليدين، الكوع أو الركبتين، البيكيني أو الإبط.', duration: '30–45 min', durationMin: 45, price: 'Contact Clinic' },
  { id: 'dermapen-pdrn',  cat: 'Skin Science',    catAr: 'علم البشرة',       name: 'Dermapen Salmon PDRN',     nameAr: 'ديرمابن سالمون PDRN',   desc: 'Advanced microneedling with Salmon PDRN for skin regeneration, pore minimizing, and remarkably smooth skin.', descAr: 'حقن إبر متقدمة مع PDRN سالمون لتجديد البشرة وتصغير المسام.', duration: '45–60 min', durationMin: 60, price: 'Contact Clinic' },
  { id: 'bbb',            cat: 'Body Sculpting',  catAr: 'نحت الجسم',        name: 'Brazilian Butt Re-shaping', nameAr: 'إعادة تشكيل البرازيلي', desc: 'Non-surgical body sculpting: fat stimulation & distribution, cellulite reduction, body contouring.', descAr: 'نحت الجسم غير الجراحي: تحفيز وتوزيع الدهون، تقليل السيلوليت، تنحيف الجسم.', duration: '45–60 min', durationMin: 60, price: 'Contact Clinic' },
];
